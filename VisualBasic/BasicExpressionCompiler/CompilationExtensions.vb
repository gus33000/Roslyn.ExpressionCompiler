...
Namespace Microsoft.CodeAnalysis.VisualBasic.ExpressionEvaluator
    ...
    Friend Module CompilationExtensions
        ...
        <Extension>
        Friend Function GetSourceMethod(compilation As VisualBasicCompilation, compiler As CompilerKind, moduleVersionId As Guid, methodHandle As MethodDefinitionHandle) As PEMethodSymbol
