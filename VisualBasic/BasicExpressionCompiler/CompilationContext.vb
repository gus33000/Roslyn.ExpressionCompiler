...
Namespace Microsoft.CodeAnalysis.VisualBasic.ExpressionEvaluator
    Friend NotInheritable Class CompilationContext
            ...
            Dim synthesizedType As New EENamedTypeSymbol(
                ...
                Function(m, container)
                    ...
                    For Each parameter In m.Parameters
                        ...
                        If _methodDebugInfo.Compiler.GetKind(parameterName) = GeneratedNameKind.None Then
        ...
        Private Function GetSourceMethodParametersInOrder(
            method As MethodSymbol,
            sourceMethod As MethodSymbol) As ImmutableArray(Of String)

            Dim containingType = method.ContainingType
            Dim isIteratorOrAsyncMethod = containingType.IsClosureOrStateMachineType(_methodDebugInfo.Compiler) AndAlso containingType.IsStateMachineType(_methodDebugInfo.Compiler)
        ...
        Private Sub GetDisplayClassVariables(
            ...
            If method.ContainingType.IsClosureOrStateMachineType(_methodDebugInfo.Compiler) Then
        ...
        Private Sub GetAdditionalDisplayClassInstances(
        ...
        Private Sub GetDisplayClassInstances(
            displayClassTypes As HashSet(Of TypeSymbol),
            displayClassInstances As ArrayBuilder(Of DisplayClassInstanceAndFields),
